...
import co.com.udea.certificacion.autenticacion.questions.ValidationViewForm;
import co.com.udea.certificacion.autenticacion.tasks.ClickOn;
...
public class ViewFormStepDefinition {
    ...
    public void estoyEnElSitio(){
        usuario.attemptsTo(OpenThe.browser(new HomePage()));
    }
